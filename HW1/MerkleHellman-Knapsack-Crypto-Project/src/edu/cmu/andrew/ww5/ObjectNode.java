...
public class ObjectNode {
     ...
     *
     */
    //The runtime in big theta notation is n
    //It has 1 operation every time it operates
     ...
     *
     */
    //The runtime in big theta notation is n, in while loop, there are 3 operations each time, therefore 3n in total.
    //Pre-conditions: it is utilized in while(source.link != null), when source.link is not null, the following code will operate
     ...
     *
     */
    //The recursive runtime big theta notation is n
    //Pre-conditions: while (source.link != null), operations happen when source.link is not null
     ...
     *
     */
    //The runtime big theta notation is n, in the while loop there are n operations
    //every loop it operates k times, which is k*n operations in total
     ...
     * @precondition position &gt; 0. modified: position can be >= 0
     ...
     *
     */
    //The runtime notation big theta is n
    ...
    public static ObjectNode listCopy_rec(ObjectNode source) {
        ...
        if (source == null) {
            ...
            copyHead = new ObjectNode(source.data, copyTail);
        }
     ...
     * @param head
     * @return the number of nodes in the list with the given head
     * @note The method is recursive, while same effect as the previous one
     */
    //The recursive runtime big theta notation is n
    ...
    /**
     * @param args the command line arguments Call method in MergeList class
     */
    /*comment only for this java application
    public static void main(String[] args) {
        // TODO code application logic here

        //Generate list contains 26 nodes and letters
        ObjectNode list = new ObjectNode('A', null);
        ObjectNode newList = list;
        for (int i = 1; i < 26; i++) {
            newList.addNodeAfter((char) ('A' + i));
            newList = newList.link;
        }

        //Call toString method to print out node data
        System.out.println(list.toString());

        //print size
        System.out.println("Number of nodes = " + listLength(list));
        System.out.println("Number of nodes = " + listLength_rec(list));

        //Make a copy
        ObjectNode r = listCopy(list);
        System.out.println(r.toString());
        System.out.println("Number of nodes in r = " + listLength(r));
        System.out.println("Number of nodes in r = " + listLength_rec(r));

        //Make a copy_rec
        ObjectNode r2 = listCopy(list);
